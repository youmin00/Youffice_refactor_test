    ...
    *,
    ...
    def run_independent_employee(
        ...
        handoff_content = (
            ...
            "단계가 아니다. 사용자가 실제 작업을 시작할 수 있도록 위 전담 범위의 제작 준비 산출물을 "
            "지금 작성한다. 조사·분석·문서 작성과 실제 구매·CAD·조립·코드 실행·성능 시험을 구분하고, "
            "직접 확인하지 않은 실행 결과를 완료했다고 표현하지 않는다. 사용자 요청에 '배정'이라는 표현이 "
            "있더라도 승인된 준비 업무를 수행하고, 다른 직원이나 외부 도구가 필요한 부분만 명확히 전달한다.\n\n"
